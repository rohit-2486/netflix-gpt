...
export const API_OPTION = {
  ...
  // export const OPENAI_KEY ="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";

  // export const OPENAI_KEY= "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"
